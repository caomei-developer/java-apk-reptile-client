...
public class FuzhuApi {

    public static String FZ_ENCRYPTION_QUANTITATIVE_PREFER = "50";

    public static String APP_ANDROID = "FUZHU_ANDROID";
    ...
    public static String FZ_BASE_URL = "http://a.lc1001.com/";

    public static String FZ_CATEGORY_URL = "app/list/booksorts";
